                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                            	<a class="btn btn-info btn-xs" href="{{URL::to('/radiologist-macro?id='.$radiologist->user_id)}}">View All</a>
                                
                            </div>
                            <h4 class="panel-title">Edit Macro of "{{$radiologist->user->name}}"</h4>
                        </div>
                        <div class="panel-body">
                            {!! Form::open(array('route' => ['radiologist-macro.update',$data->id],'class'=>'form-horizontal','method'=>'PUT','role'=>'form','data-parsley-validate novalidate')) !!}
