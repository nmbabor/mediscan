@extends('layout.app')
@section('head')
{!! Html::style('public/dashboard/cornerstone/cornerstone.min.css') !!}
@endsection
@section('content')
<style type="text/css">
        .magnifyTool{
  ...
  <div class="panel-body">
        ...
        <div class="col-md-3 no-padding">
        	...
        	@foreach($data->images as $key => $photo)
	        	<img class="study-list-img" id="{{$key}}" src='{{asset($photo->photo)}}' class="img-responsive">
	        @endforeach
        	</div>
        </div>
		<div class="col-xs-9">
...
@endsection
@section('script')
{!! Html::script('public/dashboard/cornerstone/hammer.js') !!}
{!! Html::script('public/dashboard/cornerstone/cornerstone.min.js') !!}
{!! Html::script('public/dashboard/cornerstone/cornerstoneMath.min.js') !!}
{!! Html::script('public/dashboard/cornerstone/cornerstoneWebImageLoader.min.js') !!}
{!! Html::script('public/dashboard/cornerstone/cornerstoneTools.min.js') !!}
<script>
...
<script>
    ...
    $('.study-list-img').each(function(){
     ...
     $(document).on('click','.study-list-img',function(){
        ...
        window.history.pushState('','','{{URL::to('')}}/'+url+'?image='+number);
