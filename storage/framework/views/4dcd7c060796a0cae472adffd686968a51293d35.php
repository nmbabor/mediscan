			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                        	<div class="col-md-5">
                        		<?php echo Form::open(array('route' => 'modality.store','class'=>'form-horizontal author_form','method'=>'POST','role'=>'form','data-parsley-validate novalidate')); ?>
	                                        ...
	                                        <!-- edit section -->
	                                            ...
	                                            <div class="modal fade" id="modal-dialog<?php echo $data->id;?>">
	                                                <div class="modal-dialog modal-lg">
	                                                    ...
	                                                    <?php echo Form::open(array('route' => ['modality.update',$data->id],'class'=>'form-horizontal author_form','method'=>'PUT','files'=>'true', 'id'=>'commentForm','role'=>'form','data-parsley-validate novalidate')); ?>
	                                            ...
	                                            <!-- delete section -->
	                                            <?php echo Form::open(array('route'=> ['modality.destroy',$data->id],'method'=>'DELETE')); ?>
