			    ...
			    <div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <?php echo Form::open(array('route' => 'hospital-entry.store','class'=>'form-horizontal','method'=>'POST','files'=>'true', 'role'=>'form','data-parsley-validate novalidate')); ?>
                            ...
                            <div class="col-md-6 no-padding">
                                <div class="form-group <?php echo e($errors->has('ref_doctor') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('ref_doctor','',['class'=>'form-control','placeholder'=>'Ref Doctor'])); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('patient_name') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('patient_name','',['class'=>'form-control','placeholder'=>'Patient Name'])); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('procedure_id') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('procedure_id',$procedure,'',['class'=>'form-control select','placeholder'=>'Select Procedure','id'=>'procedure_id','required'])); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('procedure_type_id') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8" id="loadProcedure">
                                        <?php echo e(Form::select('procedure_type_id',$type,'',['class'=>'form-control','placeholder'=>'Procedure Type','id'=>'procedure_type_id','required'])); ?>
                               ...
                               <div class="form-group <?php echo e($errors->has('date') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('date',date('d-m-Y'),['class'=>'form-control datepicker','placeholder'=>'Date'])); ?>
                            ...
                            <div class="col-md-6 no-padding">
                            	<div class="form-group <?php echo e($errors->has('patient_age') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('patient_age','',['class'=>'form-control','placeholder'=>'Patient Age'])); ?>
                                ...
                                <div class="form-group <?php echo e($errors->has('gender') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <label><?php echo e(Form::radio('gender','Male','',['required'])); ?> Male &nbsp; </label>
                                        <label><?php echo e(Form::radio('gender','Female','',['required'])); ?> Female </label>
                                    </div>
                                </div>
								<div class="form-group <?php echo e($errors->has('clinical_history') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::textarea('clinical_history','',['class'=>'form-control','placeholder'=>'Clinical History','rows'=>'4'])); ?>
